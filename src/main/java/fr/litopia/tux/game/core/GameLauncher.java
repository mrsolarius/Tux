...
public class GameLauncher {
    ...
    public static final String ASSETS_PATH = System.getProperty("user.dir") +File.separator+ "assets";
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedImage[] icons = new BufferedImage[] {
            ImageIO.read(new FileInputStream(ASSETS_PATH+File.separator+"Ico"+File.separator+"ico-128.png")),
            ImageIO.read(new FileInputStream(ASSETS_PATH+File.separator+"Ico"+File.separator+"ico-64.png")),
            ImageIO.read(new FileInputStream(ASSETS_PATH+File.separator+"Ico"+File.separator+"ico-32.png")),
            ImageIO.read(new FileInputStream(ASSETS_PATH+File.separator+"Ico"+File.separator+"ico-16.png"))
        };
